...
<div class="wrap">
    ...
    <!-- <li onclick="jumpPage(this)" data-href="/h5/student/release_wish">
        ...
        <li class="foot-style" data-href="/h5/student/wish_list">
            ...
            success:function (res) {
                ...
                if(res.rows|| res.rows.length!=0){
                    for (var i=0;i<res.rows.length;i++) {
                        ...
                        html +='                    </div>'
                        if (idx==2){
                            html +='                    <p class="qx-blue" onclick="cancel(this)" data-id="'+res.rows[i].id+'">我已完成</p>'
                        } else if (idx==4) {
