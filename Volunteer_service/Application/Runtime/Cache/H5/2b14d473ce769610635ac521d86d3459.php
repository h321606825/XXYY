...
<script>
    ...
    $(window).resize(function(){
        if(window.innerHeight < windowInnerHeight){
            $('.teacher-foot').css('position','absolute');
        }else{
            $('.teacher-foot').css('position','fixed');
        }
    });
                ...
                $.ajax({
                    ...
                    success:function (res) {
                        ...
                        if(res.status > 0){
                            msgAlert('发布成功')
                            setTimeout(function () {
                                window.location.href = '/h5/teacher/wish_list'
                            },1500)
                        }else {
                ...
                $.ajax({
                    ...
                    success:function (res) {
                        ...
                        if(res.status > 0){
                            msgAlert('发布成功')
                            setTimeout(function () {
                                window.location.href = '/h5/teacher/wish_release'
                            },1500)
                        }else {
                            $(e).attr('onclikc',"issueBut(this)")
                        }
