               ...
               if(res){
                // console.log(res);
                   for (var i=0;i<res.rows.length;i++) {
                       ...
                       html += '                    </div>'
                       html += '                    <p class="qx-blue" onclick="cancel(this)" data-id="'+res.rows[i].id+'" data-mobile="'+res.rows[i].s_mobile+'">认领心愿</p>'
                       html += '                </div>'
...
// 认领心愿请求
    function cancel(e) {
        ...
        var s_mobile = $(e).attr("data-mobile")
        $.ajax({
            url:"/h5/teacher/claim",
            type:"post",
            data:{
                id:id,
                s_mobile:s_mobile
            ...
            success:function (res) {
                var idx = $(".wishChislide").attr("data-inx")
                // console.log(idx)
                if (res.status == 1){
                    ajaxlist(idx,true)
                }else {
