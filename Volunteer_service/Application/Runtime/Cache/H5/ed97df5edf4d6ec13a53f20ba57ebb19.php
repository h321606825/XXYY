...
<body style="position: relative;top:0;left:0;width:100%;height:100%;">
    ...
    <ul class="teacher-foot student-foot">
            <li class="foot-style" data-href="/h5/teacher/wish_release">
                ...
                if (res.rows|| res.rows.length!=0) {
                    for (var i=0;i<res.rows.length;i++){
                        ...
                        if (inx==1){
                            ...
                            html +='                        <p class="dwc-p1">认领人：'+res.rows[i].t_name+' </p>'
                            html +='                    </div>'
                            html +='                </div>'
                        }else if (inx==3){
                            html += '<div class="qx_top">'
                        ...
                        if (inx==3 || inx==2 || inx==4){
                            ...
                            if (inx==2){
                                ...
                                html += '                        <p class="dwc-num" style="color: #666666">'+res.rows[i].t_mobile+'</p>'
                                html +='</a>'
                            }
                            html += '                    </div>'
